...
import { Camera, Mic, MicOff, Video, VideoOff, Clock, User, Building, ArrowLeft } from 'lucide-react';
    ...
    if (state.currentSession) {
      const completedSession = {
        ...
        evaluation: {
          ...
          strengths: ["Clear communication", "Professional presence", "Good eye contact", "Relevant experience"],
            ...
            <div className="flex justify-center space-x-4">
              ...
              <button
                ...
                className={`p-4 rounded-full ${
                  ...
                  isListening ? 'bg-gray-600 cursor-not-allowed' :
