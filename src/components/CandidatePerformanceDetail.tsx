...
import { ArrowLeft, User, Calendar, Clock, Award, TrendingUp, Play, Download, Share2, Eye, Star, MessageSquare, Video, Mic } from 'lucide-react';
...
export function CandidatePerformanceDetail({ candidateId, onBack }: CandidatePerformanceDetailProps) {
  ...
  const candidateData = {
    ...
    evaluation: {
      ...
      confidence: 94,
      attire: 96,
      feedback: "Exceptional performance with strong technical knowledge and excellent communication skills. Demonstrated clear problem-solving approach and leadership potential. Minor areas for improvement in handling complex system design questions.",
      strengths: [
    ...
    responses: [
      {
        ...
        response: 'I am a Senior Frontend Developer with 6 years of experience specializing in React, TypeScript, and modern web technologies. I have led multiple projects at my current company, including a complete redesign of our customer portal that increased user engagement by 40%.',
        duration: 180,
        score: 88,
      ...
      },
      {
        ...
        response: 'Recently, I tackled a performance issue where our React application was experiencing slow rendering with large datasets. I implemented virtualization using react-window and optimized our state management with useMemo and useCallback hooks, resulting in a 60% improvement in rendering performance.',
        duration: 210,
        score: 95,
      ...
      },
      {
        ...
        response: 'I believe in collaborative development and clear communication. I regularly conduct code reviews, mentor junior developers, and use tools like Slack and Jira for project coordination. I also advocate for pair programming sessions to share knowledge and maintain code quality.',
        duration: 165,
        score: 85,
      ...
      },
      {
        ...
        response: 'In 5 years, I see myself in a technical leadership role, possibly as a Staff Engineer or Engineering Manager, where I can influence technical decisions and mentor a larger team. I want to continue growing my expertise in emerging technologies while contributing to strategic product decisions.',
        duration: 145,
        score: 90,
    ...
    skillAnalysis: {
      'Technical Knowledge': {
        score: 95,
        details: 'Demonstrated exceptional understanding of React, TypeScript, and performance optimization. Provided specific examples with measurable outcomes.',
        trend: 'excellent'
      },
      'Communication Skills': {
        score: 90,
        details: 'Clear, articulate responses with good structure. Maintained professional tone throughout the interview.',
        trend: 'excellent'
      },
      'Problem Solving': {
        score: 88,
        details: 'Showed systematic approach to problem-solving with concrete examples. Could elaborate more on complex scenarios.',
        trend: 'good'
      },
      'Leadership Potential': {
        score: 85,
        details: 'Demonstrated mentoring experience and team collaboration. Shows potential for growth into leadership roles.',
        trend: 'good'
      },
      'Cultural Fit': {
        score: 92,
        details: 'Values align well with company culture. Shows enthusiasm for collaboration and continuous learning.',
        trend: 'excellent'
      }
    },
    behavioralAnalysis: {
  ...
  const getTrendIcon = (trend: string) => {
    switch (trend) {
      ...
      case 'average': return <TrendingUp className="h-4 w-4 text-yellow-600" />;
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">{candidateData.position} • {candidateData.company}</p>
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-4">
          ...
          <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3">
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className={`text-4xl font-bold mb-2 ${getScoreColor(candidateData.overallScore).split(' ')[0]}`}>
                    {candidateData.overallScore}%
                  </div>
                  <div className="text-sm text-gray-600">Overall Score</div>
                  <div className={`inline-block px-3 py-1 rounded-full text-sm font-medium mt-2 ${getScoreColor(candidateData.overallScore)}`}>
                    Grade: {getScoreGrade(candidateData.overallScore)}
                  </div>
                </div>

                <div className="text-center">
                  <div className="text-4xl font-bold text-gray-900 mb-2">{candidateData.duration}m</div>
                ...
                <div className="text-center">
                  <div className="text-4xl font-bold text-gray-900 mb-2">{candidateData.responses.length}</div>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm text-gray-600">
                    <div className="flex items-center space-x-2">
                      ...
                      <span>Applied: {new Date(candidateData.appliedDate).toLocaleDateString()}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Clock className="h-4 w-4" />
                      <span>Interviewed: {new Date(candidateData.interviewDate).toLocaleDateString()}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Award className="h-4 w-4" />
                      <span>Status: {candidateData.status.charAt(0).toUpperCase() + candidateData.status.slice(1)}</span>
                    </div>
                  </div>
                </div>

                <div>
                  <h3 className="font-medium text-gray-900 mb-2">Performance Comparison</h3>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-600">vs Position Average:</span>
                      <span className="font-medium text-green-600">
                        +{(candidateData.overallScore - candidateData.comparisonData.positionAverage).toFixed(1)}%
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">vs Industry Average:</span>
                      <span className="font-medium text-green-600">
                        +{(candidateData.overallScore - candidateData.comparisonData.industryAverage).toFixed(1)}%
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Percentile Rank:</span>
                      <span className="font-medium text-blue-600">{candidateData.comparisonData.percentileRank}th</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="border-b border-gray-200">
            <nav className="flex space-x-8 px-6">
              {[
                ...
                { id: 'responses', label: 'Response Analysis', icon: MessageSquare },
                { id: 'skills', label: 'Skill Breakdown', icon: TrendingUp },
                { id: 'behavioral', label: 'Behavioral Analysis', icon: Eye }
              ].map((tab) => (
                <button
                  key={tab.id}
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
                ...
                <div className="space-y-6">
                  {[
                    { label: 'Communication Skills', score: candidateData.evaluation.communication, icon: '💬' },
                    { label: 'Technical Knowledge', score: candidateData.evaluation.technical, icon: '🔧' },
                    { label: 'Body Language', score: candidateData.evaluation.bodyLanguage, icon: '👤' },
                    { label: 'Confidence Level', score: candidateData.evaluation.confidence, icon: '💪' },
                    { label: 'Professional Attire', score: candidateData.evaluation.attire, icon: '👔' }
                  ].map((item, index) => (
                    <div key={index}>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2">
                      {candidateData.evaluation.strengths.map((strength, index) => (
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {candidateData.evaluation.improvements.map((improvement, index) => (
                        <li key={index} className="text-sm text-gray-700 flex items-start space-x-2">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold text-green-600">Strong Match</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-lg font-bold text-green-800 mb-2">Highly Recommended</div>
                  <p className="text-sm text-gray-600">
                    Exceptional candidate with strong technical skills and excellent communication. 
        ...
        {activeTab === 'responses' && (
          <div className="space-y-6">
            {candidateData.responses.map((response, index) => (
              <div key={response.questionId} className="bg-white rounded-xl shadow-sm p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <span className="text-sm text-gray-500">{response.duration}s</span>
                      <span className={`px-2 py-1 rounded text-xs font-medium ${getScoreColor(response.score)}`}>
                        {response.score}%
                      </span>
                    </div>
                    <h3 className="text-lg font-medium text-gray-900 mb-3">{response.question}</h3>
                  </div>
                  <div className="flex items-center space-x-2">
        ...
        {activeTab === 'skills' && (
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-6">
                {Object.entries(candidateData.skillAnalysis).map(([skill, data]) => (
                  <div key={skill}>
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center space-x-2">
                      ...
                      <span className={`font-bold ${getScoreColor(data.score).split(' ')[0]}`}>
                        {data.score}%
                      </span>
                    </div>
                ...
                {Object.entries(candidateData.skillAnalysis).map(([skill, data]) => (
                  <div key={skill} className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <span className={`text-sm font-medium ${data.score > 72 ? 'text-green-600' : 'text-red-600'}`}>
                        {data.score > 72 ? '+' : ''}{(data.score - 72).toFixed(1)}%
                      </span>
                    </div>
                  </div>
                ))}
        ...
        {activeTab === 'behavioral' && (
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-6">
                {Object.entries(candidateData.behavioralAnalysis).map(([behavior, score]) => (
                  <div key={behavior}>
                    <div className="flex items-center justify-between mb-2">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h2 className="text-xl font-bold text-gray-900 mb-6">Video Analysis Insights</h2>
              <div className="space-y-4">
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-green-700 space-y-1">
                    ...
                    <li>• Confident posture and professional demeanor</li>
