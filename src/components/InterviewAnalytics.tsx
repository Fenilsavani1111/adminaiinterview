...
import { ArrowLeft, TrendingUp, Users, Clock, Award, Filter, Calendar, Download, Eye, Star, BarChart3, PieChart, Activity } from 'lucide-react';
...
export function InterviewAnalytics() {
  ...
  const [selectedJobForListing, setSelectedJobForListing] = useState<{id: string, title: string, company: string} | null>(null);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{mockAnalytics.overview.totalInterviews}</p>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{mockAnalytics.overview.passRate}%</p>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{mockAnalytics.overview.averageDuration}m</p>
                <p className="text-sm text-blue-600 mt-1">↑ 0.5m from last month</p>
              </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-900">Performance by Job Position</h2>
                  ...
                  <div key={job.jobId} className="border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="text-right">
                        <div className={`text-2xl font-bold ${getScoreColor(job.averageScore)}`}>
                          {job.averageScore}%
                        </div>
                        <button
                          onClick={() => setSelectedJobForListing({
                            id: job.jobId,
                            title: job.title,
                            company: job.company
                          })}
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                      <div className="text-center">
                        <div className="text-lg font-semibold text-gray-900">{job.passRate}%</div>
                        <div className="text-xs text-gray-500">Pass Rate</div>
                      </div>
                      <div className="text-center">
                        <div className="text-lg font-semibold text-gray-900">{job.averageDuration}m</div>
                        <div className="text-xs text-gray-500">Avg Duration</div>
                      </div>
                      <div className="text-center">
                        <div className="text-lg font-semibold text-gray-900">{job.totalInterviews}</div>
                        <div className="text-xs text-gray-500">Total Interviews</div>
                      </div>
                      <div className="text-center">
                        <div className="text-lg font-semibold text-green-600">
                          {Math.round(job.totalInterviews * (job.passRate / 100))}
                        </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {Object.entries(job.topSkillScores).map(([skill, score]) => (
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-900">Individual Candidate Performance</h2>
              ...
              <div className="space-y-4">
                {mockAnalytics.candidatePerformance.map((candidate, index) => (
                  <div key={candidate.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer"
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-500">
                          {new Date(candidate.interviewDate).toLocaleDateString()} • {candidate.duration}m
                        </div>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className={`text-xl font-bold ${getScoreColor(candidate.overallScore)} flex items-center space-x-2`}>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex items-end space-x-1 h-20">
                    {mockAnalytics.trends.weeklyScores.map((score, index) => (
                      <div key={index} className="flex-1 bg-blue-200 rounded-t" style={{ height: `${(score / 100) * 100}%` }}>
                        <div className="bg-blue-600 rounded-t h-full" style={{ height: `${score}%` }}></div>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-end space-x-1 h-16">
                    {mockAnalytics.trends.monthlyInterviews.map((count, index) => (
                      <div key={index} className="flex-1 bg-green-200 rounded-t">
                        <div 
                          className="bg-green-600 rounded-t" 
                          style={{ height: `${(count / Math.max(...mockAnalytics.trends.monthlyInterviews)) * 100}%` }}
                        ></div>
                      </div>
                    ))}
                  </div>
            ...
            {/* Skill Analysis */}
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Skill Performance Analysis</h3>
              
              <div className="space-y-4">
                {Object.entries(mockAnalytics.trends.skillTrends).map(([skill, scores]) => {
              ...
              <div className="space-y-4">
                <div className="p-3 bg-green-50 rounded-lg">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <span className="text-sm font-medium text-green-800">Top Performing Role</span>
                  </div>
                  <p className="text-sm text-green-700">
                    {mockAnalytics.overview.topPerformingJob} has the highest average score at 82.4%
                  </p>
                </div>
                ...
                <div className="p-3 bg-blue-50 rounded-lg">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <span className="text-sm font-medium text-blue-800">Communication Excellence</span>
                  </div>
                  <p className="text-sm text-blue-700">
                    Communication skills show consistent improvement across all positions
                  </p>
                </div>
                ...
                <div className="p-3 bg-yellow-50 rounded-lg">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <span className="text-sm font-medium text-yellow-800">Duration Insight</span>
                  </div>
