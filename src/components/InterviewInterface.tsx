    ...
    if (!isRecording) {
      ...
      if (state.currentSession) {
        const response: InterviewResponse = {
          ...
          response: currentResponse || `Response to: ${sampleQuestions[currentQuestionIndex].question}`,
    ...
    if (state.currentSession) {
      const completedSession = {
        ...
        evaluation: {
          ...
          feedback: "Overall strong performance with good communication skills. Consider improving technical depth in responses.",
            ...
            <div className="p-8 text-center">
              <div className="mb-8">
                ...
                <p className="text-lg text-gray-600">
                  Hi {state.currentUser?.name}! Let's begin your practice session for {state.currentUser?.position}
                </p>
              </div>
