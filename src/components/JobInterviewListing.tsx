...
import { JobInterviewAnalytics } from './JobInterviewAnalytics';
...
export function JobInterviewListing({
  ...
  const [activeView, setActiveView] = useState<'candidates' | 'analytics'>(
    'candidates',
  );
  ...
  // Completed candidates — passed to analytics component
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4">
              ...
              <div>
                ...
                {jobpost?.interviewStartDateTime && (
                  <div className="mt-2 inline-flex items-center gap-2 rounded-lg bg-indigo-50 px-3 py-1.5 text-sm font-medium text-indigo-800">
                    ...
                    Scheduled:{' '}
                    {moment(jobpost.interviewStartDateTime).format(
                      'DD-MM-YYYY HH:mm A',
                    )}
                  </div>
                )}
            ...
            <div className="flex items-center space-x-4">
              ...
              {candidates?.length > 0 && activeView === 'candidates' && (
                <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeView === 'analytics' && (
          <JobInterviewAnalytics
            candidates={candidates}
            onSelectCandidate={setSelectedInterview}
          />
        )}
                        ...
                        <tr key={interview.id} className="hover:bg-gray-50">
                          <td className="px-6 py-4">
                            <input
                              ...
                              onChange={() =>
                                toggleCandidateSelection(interview.id)
                              }
                              className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                          </td>
                            ...
                            <div className="text-sm text-gray-900">
                              ...
                              {interview.appliedDate === null ? (
                                ...
                                <div className="text-xs text-gray-500 mt-2">
                                  Applied:{' '}
                                  {moment(interview.appliedDate).format(
                                    'DD-MM-YYYY',
                                  )}
                                </div>
                              )}
